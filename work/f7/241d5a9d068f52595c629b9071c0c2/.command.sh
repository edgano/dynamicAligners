...
t_coffee -reg -reg_method dynamic_msa          -seq seatoxin.fa          -reg_nseq 1000          -dynamic 10000          -reg_homoplasy          -outfile seatoxin.reg_align.1000.dynamic.10000.dynamic.with.famsaSL.tree.aln
